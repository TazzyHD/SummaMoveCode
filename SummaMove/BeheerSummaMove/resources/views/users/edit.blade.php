    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('users.update', ['user' => $user->id]) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password" id="password" value="{{ $user->password}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
